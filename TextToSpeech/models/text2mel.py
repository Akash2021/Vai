...
class TextEnc(nn.Module):
    def __init__(self, vocab, e=hp.e, d=hp.d):
        ...
        self.layers = nn.Sequential(Conv(e, 2 * d, 1, 1, nonlinearity='relu'),
                                    Conv(2 * d, 2 * d, 1, 1),
                                    BasicBlock(2 * d, 3, 1),
                                    BasicBlock(2 * d, 3, 3),
                                    BasicBlock(2 * d, 3, 9),
...
class AudioEnc(nn.Module):
    def __init__(self, d=hp.d, f=hp.n_mels):
        ...
        self.layers = nn.Sequential(
            ...
            CausalConv(d, d, 1, 1),
            CausalBasicBlock(d, 3, 1),
            CausalBasicBlock(d, 3, 3),
            CausalBasicBlock(d, 3, 9),
            CausalBasicBlock(d, 3, 27),
            CausalBasicBlock(d, 3, 1),
            CausalBasicBlock(d, 3, 3),
            CausalBasicBlock(d, 3, 9),
            CausalBasicBlock(d, 3, 27),
